...
export default function TRCEarnings({ onBack }) {
  ...
  return (
    <div className="md:p-6 min-h-screen">
      ...
      {/* TRC Balance Card */}
      <div className="bg-purple-50 rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:justify-between mb-8 relative overflow-hidden">
        <div>
          <div className="text-gray-800 font-medium text-sm mb-1">TRC Balance</div>
          <div className="text-2xl font-bold mb-4 flex items-center gap-2">
            ₦{trcBalance.toLocaleString()}
          </div>
          <div className="flex gap-6 text-xs text-gray-500 overflow-x-auto md:overflow-x-visible md:scrollbar-none scrollbar-thin scrollbar-thumb-gray-300 -mx-4 px-4" style={{ WebkitOverflowScrolling: 'touch', overflowY: 'hidden' }}>
      ...
      <div className="bg-white md:rounded-2xl md:border border-gray-200 md:p-6 mb-8">
        ...
        <form className="grid md:grid-cols-1 gap-6 items-end">
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-900">ENTER AMOUNT TO TRANSFER</label>
            <input
              type="text"
              className="border border-gray-200 rounded-lg px-4 py-4 focus:outline-none focus:ring-2 focus:ring-emerald-200 text-sm"
          ...
          <div className='md:grid-cols-2 grid grid-cols-1 gap-4'>
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                className="border border-gray-200 rounded-lg px-4 py-4 bg-gray-50 text-sm"
            ...
            <div className="flex flex-col gap-2 md:mt-0 mt-4">
              ...
              <select
                className="border border-gray-200 rounded-lg px-4 py-4 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-200 text-sm appearance-none"
                value={destination}
          ...
          <div className="flex mt-4 md:mt-6">
            <button
              type="submit"
              className="bg-primary px-8 hover:bg-purple-800 text-white font-semibold rounded-lg py-3 transition w-fit"
            >
              Transfer Now
            </button>
          </div>
        </form>
        <div className="flex items-center text-xs text-gray-400 mt-4 gap-2">
