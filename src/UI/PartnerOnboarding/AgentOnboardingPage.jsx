...
const AgentOnboardingPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.agency || formData.agency === 'Select agency') {
  ...
  const handleFileUpload = (fileType, event) => {
    ...
    if (file) {
      ...
      if (fileType === 'logo' && !allowedImageTypes.includes(file.type)) {
        setErrors(prev => ({
          ...prev,
          logo: 'Please upload a valid image file (JPG, PNG, JPEG)'
        }));
        return;
      }
        ...
        <div className="w-full max-w-4xl">
          <div className="flex justify-between items-center mb-8">
            ...
            <p className="text-sm text-gray-600">
              Already a partner?{" "}
              <a href="/partner/signin" className="font-medium text-complimentary hover:underline">
                Sign in
              </a>
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div
                  ...
                  className={`flex flex-col justify-center items-center w-full h-40 px-6 py-4 mt-2 bg-white border-2 border-dashed rounded-md cursor-pointer hover:bg-gray-50 ${
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-gray-600 text-center">
                    {files.logo ? (
                      <span className="font-semibold">{files.logo.name}</span>
                    ) : (
                      <>
                        <span className="font-semibold">Drop your image here, or browse</span>
                        <p className="text-xs text-gray-500 mt-1">Supports JPG, PNG, and JPEG (Max 5MB)</p>
                      </>
                    )}
                  </p>
                </div>
                  ...
                  <p className="mt-2 text-sm text-gray-600 text-center">
                    {files.workDocument ? (
                      ...
                      <>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Supports PDF and JPG (Max 5MB)</p>
                      </>
                    )}
                  </p>
                </div>
              ...
              <button
                ...
                className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${
                  isSubmitting
                    ...
                    : 'bg-primary hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary'
                }`}
              >
