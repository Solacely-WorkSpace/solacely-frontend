...
const PartnerSignInPage = () => {
  ...
  const handleSetLoginMethod = (method) => {
        ...
        <div className="w-full md:w-2/3 flex flex-col p-6 sm:p-8 md:p-12">
          <div className="flex justify-between items-center">
            ...
            <p className="text-sm text-gray-600">
              Not a partner yet?{" "}
              <Link href="/partner-onboarding" className="font-semibold text-complementary hover:text-green-700">
                Sign up
              </Link>
            </p>
          </div>
              ...
              {!resetEmailSent ? (
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-complementary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="flex w-full min-h-screen bg-white">
      ...
      <div className="w-full md:w-2/3 flex flex-col p-6 sm:p-8 md:p-12">
        <div className="flex justify-end items-center">
          <p className="text-sm text-gray-600">
            Not a partner yet?{" "}
            <Link href="/partner" className="font-semibold text-complementary hover:text-green-700">
              Sign up
            </Link>
          </p>
        </div>
              ...
              <form onSubmit={emailForm.handleSubmit(onEmailSubmit)} className="space-y-6">
                ...
                <div className="text-right -mt-2">
                  <button
                    ...
                    className="text-sm font-medium text-complementary hover:text-green-700"
                  >
                    Forgot password?
                  </button>
                </div>
