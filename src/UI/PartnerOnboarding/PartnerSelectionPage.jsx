...
const partnerTypes = [
  {
    ...
    illustration: '/images/partneronboarding/bro1.png' 
  },
  {
    id: 'agent',
    ...
    description: "Connect with us. Every step of the journey, we'll be here for you.",
    route: '/partner/agent',
    illustration: '/images/partneronboarding/bro.png' 
  },
  {
    id: 'landlord',
    ...
    illustration: '/images/partneronboarding/illustration.png' 
  }
];
      ...
      <div className="w-full md:w-2/3 flex flex-col p-6 sm:p-8 md:p-12">
        ...
        <div className="flex justify-end items-center mb-12">
          <p className="text-sm text-gray-600">
            Already a partner?{" "}
            <Link href="/partner/signin" className="font-semibold text-green-600 hover:text-green-700">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="w-full max-w-5xl mx-auto flex flex-col justify-center flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {partnerTypes.map((partner) => (
                <div
                  key={partner.id}
                  className="bg-gray-50 rounded-lg border border-gray-200 p-6 flex flex-col text-left transition-shadow hover:shadow-md"
                >
                  {/* Card Content */}
                  ...
                  <div className="mb-4">
                    <Link
                      href={partner.route}
                      className="inline-block text-sm font-medium text-purple-700 border border-purple-200 px-4 py-2 rounded-lg hover:bg-purple-100 transition-colors"
                    >
                      Get started
                    </Link>
                  </div>
