      ...
      <div className=" flex flex-col text-center items-center lg:items-start lg:text-left ">
        <article className="  flex flex-col gap-2">
          ...
          <p className=" text-slate-300 text-xs  font-light w-full lg:w-1/2 ">
            Our vision is to have everyone have an affordable place to call home. 
            We are passionate about creating an accessible and transparent ecosystem 
            that allows home seekers a way to explore real estate options, manage their rent payments,
